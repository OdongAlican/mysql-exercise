...
SELECT name, gdp/population AS pop FROM world WHERE population >= 200000000
...
SELECT name, population/1000000 AS per_million FROM world WHERE continent = 'South America'
...
/*
9.Show the name and population in millions and the GDP in billions for 
...
SELECT name, ROUND(population/1000000, 2) AS pop_millions, ROUND(gdp/1000000000, 2) 
AS gdp_billions  FROM world WHERE continent =  'South America';
